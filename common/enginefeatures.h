...
#define ENGINE_COMPUTE_STUDIO_LERP	(1<<7)	// enable MOVETYPE_STEP lerping back in engine, controlled using cvar sv_computestudiolerp (mod-maker value will be ignored)
