...
export CFLAGS="-static-libgcc -no-pthread -msse2 -msse -msse3 -mmmx -march=i586 -Ofast -ffast-math -funsafe-math-optimizations -funsafe-loop-optimizations -g -gdwarf-2 -fomit-frame-pointer" # add sse2 to workaround mingw multiple definition of MemoryBarrier bug
