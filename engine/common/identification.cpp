...
void ID_Init( void )
{
	...
	{
		CHAR szBuf[MAX_PATH];
		ID_GetKeyData( HKEY_CURRENT_USER, (char*)"Software\\Xash3D\\", (char*)"xash_id", (LPBYTE)szBuf, MAX_PATH );
...
#elif XASH_WIN32
	{
		...
		ID_SetKeyData( HKEY_CURRENT_USER, (char*)"Software\\Xash3D\\", REG_SZ, (char*)"xash_id", (LPBYTE)Buf, Q_strlen(Buf) );
	}
#else
	{
		const char *home = getenv( "HOME" );
