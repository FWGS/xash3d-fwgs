...
void Test_RunDelta( void )
{
	...
	Delta_AddField( dt, "dt_string", DT_STRING, false, 1, 1.0f, 1.0f );
	Delta_AddField( dt, "dt_timewindow_big", DT_TIMEWINDOW_BIG, false, 24, 1000.f, 1.0f );
	Delta_AddField( dt, "dt_timewindow_8", DT_TIMEWINDOW_8, false, 8, 1.0f, 1.0f );
	Delta_AddField( dt, "dt_angle", DT_ANGLE, false, 16, 1.0f, 1.0f );
	Delta_AddField( dt, "dt_float_signed", DT_FLOAT, true, 22, 100.0f, 1.0f );
	Delta_AddField( dt, "dt_float_unsigned", DT_FLOAT, false, 24, 10000.0f, 0.1f );
	Delta_AddField( dt, "dt_integer_signed", DT_INTEGER, true, 24, 1.0f, 1.0f );
	Delta_AddField( dt, "dt_integer_unsigned", DT_INTEGER, false, 24, 1.0f, 1.0f );
	Delta_AddField( dt, "dt_short_signed", DT_SHORT, true, 24, 2.0f, 1.0f );
	Delta_AddField( dt, "dt_short_unsigned", DT_SHORT, false, 15, 1.0f, 1.0f );
	Delta_AddField( dt, "dt_byte_signed", DT_BYTE, true, 6, 1.0f, 1.0f );
	Delta_AddField( dt, "dt_byte_unsigned", DT_BYTE, false, 8, 1.0f, 1.0f );
