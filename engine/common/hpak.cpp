...
static inline void HPAK_ResourceFromCompat( resource_t *dest, dresource_t *src )
{
	...
	dest->pNext = dest->pPrev = (resource_t*)(void*)0xDEADBEEF;
}
...
static qboolean HPAK_Validate( const char *filename, qboolean quiet, qboolean delete_ )
{
	file_t		*f;
	hpak_lump_t	*dataDir;
	hpak_header_t	hdr;
