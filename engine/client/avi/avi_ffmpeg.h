...
#ifdef ALLOW_UNSUPPORTED_FFMPEG
// Trick the application into accepting unsupported ffmepg version
#undef SUPPORTED_AVU_VERSION_MAJOR
#define SUPPORTED_AVU_VERSION_MAJOR LIBAVUTIL_VERSION_MAJOR

#undef SUPPORTED_AVF_VERSION_MAJOR
#define SUPPORTED_AVF_VERSION_MAJOR LIBAVFORMAT_VERSION_MAJOR

#undef SUPPORTED_AVC_VERSION_MAJOR
#define SUPPORTED_AVC_VERSION_MAJOR LIBAVCODEC_VERSION_MAJOR

#undef SUPPORTED_SWR_VERSION_MAJOR
#define SUPPORTED_SWR_VERSION_MAJOR LIBSWRESAMPLE_VERSION_MAJOR

#undef SUPPORTED_SWS_VERSION_MAJOR
