...
static std::unordered_map<const char*, void**> cdll_exports = {
...
int GAME_EXPORT CL_GetScreenInfo( SCREENINFO *pscrinfo )
{
	...
	if (scale_factor == 0.0f)
		scale_factor = (float)refState.height / 800.0f;
...
{
	rgba_t color = { (byte)r, (byte)g, (byte)b, (byte)255 };
...
*/
	...
	clgame.hInstance = (void*)1337;//COM_LoadLibrary( name, false, false );
...
*/
	...
	//{ "Initialize", (void**)&clgame.dllFuncs.pfnInitialize },
	clgame.dllFuncs.pfnInitialize = MyExports::Initialize;

	//{ "HUD_VidInit", (void**)&clgame.dllFuncs.pfnVidInit },
	clgame.dllFuncs.pfnVidInit = MyExports::HUD_VidInit;

	//{ "HUD_Init", (void**)&clgame.dllFuncs.pfnInit },
	clgame.dllFuncs.pfnInit = MyExports::HUD_Init;

	//{ "HUD_Shutdown", (void**)&clgame.dllFuncs.pfnShutdown },
	clgame.dllFuncs.pfnShutdown = MyExports::HUD_Shutdown;
	
	//{ "HUD_Redraw", (void**)&clgame.dllFuncs.pfnRedraw },
	clgame.dllFuncs.pfnRedraw = MyExports::HUD_Redraw;

	//{ "HUD_UpdateClientData", (void**)&clgame.dllFuncs.pfnUpdateClientData },
	clgame.dllFuncs.pfnUpdateClientData = MyExports::HUD_UpdateClientData;

	//{ "HUD_Reset", (void**)&clgame.dllFuncs.pfnReset },
	clgame.dllFuncs.pfnReset = MyExports::HUD_Reset;

	//{ "HUD_PlayerMove", (void**)&clgame.dllFuncs.pfnPlayerMove },
	clgame.dllFuncs.pfnPlayerMove = MyExports::HUD_PlayerMove;

	//{ "HUD_PlayerMoveInit", (void**)&clgame.dllFuncs.pfnPlayerMoveInit },
	clgame.dllFuncs.pfnPlayerMoveInit = MyExports::HUD_PlayerMoveInit;

	//{ "HUD_PlayerMoveTexture", (void**)&clgame.dllFuncs.pfnPlayerMoveTexture },
	clgame.dllFuncs.pfnPlayerMoveTexture = MyExports::HUD_PlayerMoveTexture;

	//{ "HUD_ConnectionlessPacket", (void**)&clgame.dllFuncs.pfnConnectionlessPacket },
	clgame.dllFuncs.pfnConnectionlessPacket = MyExports::HUD_ConnectionlessPacket;
	...
	//{ "HUD_GetHullBounds", (void**)&clgame.dllFuncs.pfnGetHullBounds },
	clgame.dllFuncs.pfnGetHullBounds = MyExports::HUD_GetHullBounds;

	//{ "HUD_Frame", (void**)&clgame.dllFuncs.pfnFrame },
	clgame.dllFuncs.pfnFrame = MyExports::HUD_Frame;

	//{ "HUD_PostRunCmd", (void**)&clgame.dllFuncs.pfnPostRunCmd },
	clgame.dllFuncs.pfnPostRunCmd = MyExports::HUD_PostRunCmd;

	//{ "HUD_Key_Event", (void**)&clgame.dllFuncs.pfnKey_Event },
	clgame.dllFuncs.pfnKey_Event = MyExports::HUD_Key_Event;

	//{ "HUD_AddEntity", (void**)&clgame.dllFuncs.pfnAddEntity },
	clgame.dllFuncs.pfnAddEntity = MyExports::HUD_AddEntity;

	//{ "HUD_CreateEntities", (void**)&clgame.dllFuncs.pfnCreateEntities },
	clgame.dllFuncs.pfnCreateEntities = MyExports::HUD_CreateEntities;

	//{ "HUD_StudioEvent", (void**)&clgame.dllFuncs.pfnStudioEvent },
	clgame.dllFuncs.pfnStudioEvent = MyExports::HUD_StudioEvent;

	//{ "HUD_TxferLocalOverrides", (void**)&clgame.dllFuncs.pfnTxferLocalOverrides },
	clgame.dllFuncs.pfnTxferLocalOverrides = MyExports::HUD_TxferLocalOverrides;

	//{ "HUD_ProcessPlayerState", (void**)&clgame.dllFuncs.pfnProcessPlayerState },
	clgame.dllFuncs.pfnProcessPlayerState = MyExports::HUD_ProcessPlayerState;

	//{ "HUD_TxferPredictionData", (void**)&clgame.dllFuncs.pfnTxferPredictionData },
	clgame.dllFuncs.pfnTxferPredictionData = MyExports::HUD_TxferPredictionData;

	//{ "HUD_TempEntUpdate", (void**)&clgame.dllFuncs.pfnTempEntUpdate },
	clgame.dllFuncs.pfnTempEntUpdate = MyExports::HUD_TempEntUpdate;

	//{ "HUD_DrawNormalTriangles", (void**)&clgame.dllFuncs.pfnDrawNormalTriangles },
	clgame.dllFuncs.pfnDrawNormalTriangles = MyExports::HUD_DrawNormalTriangles;

	//{ "HUD_DrawTransparentTriangles", (void**)&clgame.dllFuncs.pfnDrawTransparentTriangles },
	clgame.dllFuncs.pfnDrawTransparentTriangles = MyExports::HUD_DrawTransparentTriangles;

	//{ "HUD_GetUserEntity", (void**)&clgame.dllFuncs.pfnGetUserEntity },
	clgame.dllFuncs.pfnGetUserEntity = MyExports::HUD_GetUserEntity;

	//{ "Demo_ReadBuffer", (void**)&clgame.dllFuncs.pfnDemo_ReadBuffer },
	clgame.dllFuncs.pfnDemo_ReadBuffer = MyExports::Demo_ReadBuffer;

	//{ "CAM_Think", (void**)&clgame.dllFuncs.CAM_Think },
	clgame.dllFuncs.CAM_Think = MyExports::CAM_Think;

	//{ "CL_IsThirdPerson", (void**)&clgame.dllFuncs.CL_IsThirdPerson },
	clgame.dllFuncs.CL_IsThirdPerson = MyExports::CL_IsThirdPerson;

	//{ "CL_CameraOffset", (void**)&clgame.dllFuncs.CL_CameraOffset },	// unused callback. Now camera code is completely moved to the user area
	clgame.dllFuncs.CL_CameraOffset = MyExports::CL_CameraOffset;

	//{ "CL_CreateMove", (void**)&clgame.dllFuncs.CL_CreateMove },
	clgame.dllFuncs.CL_CreateMove = MyExports::CL_CreateMove;

	//{ "IN_ActivateMouse", (void**)&clgame.dllFuncs.IN_ActivateMouse },
	clgame.dllFuncs.IN_ActivateMouse = MyExports::IN_ActivateMouse;

	//{ "IN_DeactivateMouse", (void**)&clgame.dllFuncs.IN_DeactivateMouse },
	clgame.dllFuncs.IN_DeactivateMouse = MyExports::IN_DeactivateMouse;

	//{ "IN_MouseEvent", (void**)&clgame.dllFuncs.IN_MouseEvent },
	clgame.dllFuncs.IN_MouseEvent = MyExports::IN_MouseEvent;

	//{ "IN_Accumulate", (void**)&clgame.dllFuncs.IN_Accumulate },
	clgame.dllFuncs.IN_Accumulate = MyExports::IN_Accumulate;

	//{ "IN_ClearStates", (void**)&clgame.dllFuncs.IN_ClearStates },
	clgame.dllFuncs.IN_ClearStates = MyExports::IN_ClearStates;

	//{ "V_CalcRefdef", (void**)&clgame.dllFuncs.pfnCalcRefdef },
	clgame.dllFuncs.pfnCalcRefdef = MyExports::V_CalcRefdef;

	//{ "KB_Find", (void**)&clgame.dllFuncs.KB_Find },
	clgame.dllFuncs.KB_Find = (void* (__cdecl*)(const char*))MyExports::KB_Find;
