...
void CL_InitClientMove( void )
{
	...
	clgame.pmove->PM_PointContents = (int(__cdecl*)(float*, int*))PM_CL_PointContents;
	clgame.pmove->PM_TruePointContents = pfnTruePointContents;
	clgame.pmove->PM_HullPointContents = (int(__cdecl*)(hull_t*, int, float*))PM_HullPointContents;
