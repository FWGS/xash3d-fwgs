...
static render_api_t gRenderAPI =
{
	...
	(void* (__cdecl*)(const char*,qboolean))AVI_LoadVideo,
	(int(__cdecl*)(void*,int*,int*,float*))AVI_GetVideoInfo,
	(int(__cdecl*)(void*,float))AVI_GetVideoFrameNumber,
	(byte* (__cdecl*)(void*,int))AVI_GetVideoFrame,
	...
	COM_CompareFileTime,
	Host_Error,
	(void* (__cdecl*)(int))CL_ModelHandle,
	pfnTime,
	Cvar_Set,
	S_FadeMusicVolume,
	COM_SetRandomSeed,
