...
================
*/
particle_t * GAME_EXPORT CL_AllocParticleFast( void )
{
	particle_t *p = NULL;
...
==============
*/
cl_entity_t * GAME_EXPORT R_BeamGetEntity( int index )
{
	if( index < 0 )
...
===============
*/
void GAME_EXPORT R_DebugParticle( const vec3_t pos, byte r, byte g, byte b )
{
	particle_t	*p;
...
===============
*/
void GAME_EXPORT CL_Particle( const vec3_t org, int color, float life, int zpos, int zvel )
{
	particle_t	*p;
...
===============
*/
particle_t * GAME_EXPORT R_TracerParticles( float *org, float *vel, float life )
{
...
void GAME_EXPORT CL_DrawEFX( float time, qboolean fTrans )
{
	CL_FreeDeadBeams();
...
void GAME_EXPORT CL_ThinkParticle( double frametime, particle_t *p )
{
