...
CVAR_DEFINE( window_width, "width", "720", FCVAR_RENDERINFO|FCVAR_VIDRESTART, "screen width" );
CVAR_DEFINE( window_height, "height", "720", FCVAR_RENDERINFO|FCVAR_VIDRESTART, "screen height" );
