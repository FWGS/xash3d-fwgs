...
CVAR_DEFINE( engine::gl_vsync, "gl_vsync", "0", FCVAR_ARCHIVE,  "enable vertical syncronization" );
CVAR_DEFINE( engine::r_showtextures, "r_showtextures", "0", FCVAR_CHEAT, "show all uploaded textures" );
CVAR_DEFINE_AUTO( r_adjust_fov, "1", FCVAR_ARCHIVE, "making FOV adjustment for wide-screens" );
CVAR_DEFINE( engine::r_decals, "r_decals", "4096", FCVAR_ARCHIVE, "sets the maximum number of decals" );
CVAR_DEFINE_AUTO( gl_msaa_samples, "0", FCVAR_GLCONFIG, "samples number for multisample anti-aliasing" );
CVAR_DEFINE( engine::gl_clear, "gl_clear", "0", FCVAR_ARCHIVE, "clearing screen after each frame" );
...
void engine::R_GetTextureParms( int *w, int *h, int texnum )
{
...
static ref_api_t gEngfuncs =
{
	...
	(cvar_t* (__cdecl*)(const char*,const char*,int,const char*))Cvar_Get,
	(cvar_t* (__cdecl*)(const char*,int))Cvar_FindVarExt,
	Cvar_VariableValue,
	Cvar_VariableString,
	Cvar_SetValue,
	Cvar_Set,
