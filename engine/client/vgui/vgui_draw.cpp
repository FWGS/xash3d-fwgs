...
qboolean VGui_LoadProgs( HINSTANCE hInstance )
{
	...
	if( !client )
	{
		...
		hInstance = vgui.hInstance = (HINSTANCE)COM_LoadLibrary( vguiloader, false, false );
	...
	F = (void(__cdecl*)(vguiapi_t*))COM_GetProcAddress( hInstance, client ? "InitVGUISupportAPI" : "InitAPI" );
